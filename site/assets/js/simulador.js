...
document.getElementById('spanText').innerHTML = `Você normalmente gastaria R$: ${(6500.2331).toFixed(2)} mensalmente <br>
...
document.getElementById('spanText').innerHTML = `Você normalmente gastaria R$: ${(8500.2331).toFixed(2)} mensalmente <br>
...
document.getElementById('spanText').innerHTML = `Você normalmente gastaria R$: ${(11300.2331).toFixed(2)} mensalmente <br>
...
document.getElementById('spanText').innerHTML = `Você normalmente gastaria R$: ${(15300.2331).toFixed(2)} mensalmente <br>
...
document.getElementById('spanText').innerHTML = `Você normalmente gastaria R$: ${(20300.2331).toFixed(2)} mensalmente <br>
...
document.getElementById('spanText').innerHTML = `Você normalmente gastaria R$: ${(26300.2331).toFixed(2)} mensalmente <br>
...
document.getElementById('spanText').innerHTML = `Você normalmente gastaria R$: ${(35300.2331).toFixed(2)} mensalmente <br>
